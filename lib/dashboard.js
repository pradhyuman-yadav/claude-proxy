...
function renderDashboard({ stats, modelRegistry, port, hasToken, authRequired, baseUrl, cliVersion, setupMode, geminiEnabled, geminiModels }) {
  ...
  const vars = {
    ...
    geminiLabel: geminiEnabled ? 'ENABLED' : 'DISABLED',
